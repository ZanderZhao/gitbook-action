...
点击Actions，选择Simple workflow

![](https://raw.githubusercontent.com/ZanderZhao/images/master/img2020/20200104171525.png)

复制下面内容并粘贴，将上面文件名改成`gitbook-action.yml`或者其他自定义的都可以，点击Start commit就可以自动部署了，可以在Actions里面查看部署结果。
